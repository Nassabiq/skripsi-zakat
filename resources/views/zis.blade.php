        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-4 mb-3 mb-sm-0 d-flex justify-content-center">
                    <a href="zakat-mal">
                        <div class="card" style="width: 18rem; color: black">
                            <img src="img/donation-jar.jpg" alt="Zakat Ma'al" style="height: 15rem" />
                            <div class="card-body">
                ...
                <div class="col-md-4 d-flex justify-content-center">
                    <a href="zakat-fitrah">
                        <div class="card" style="width: 18rem; color: black">
                            <img src="img/sack-rice.jpg" alt="Zakat Fitrah" style="height: 15rem" />
                            <div class="card-body">
                ...
                <div class="col-md-4 d-flex justify-content-center">
                    <a href="infaq-sodaqoh">
                        <div class="card" style="width: 18rem; color: black">
                            <img src="img/money.jpg" alt="Infaq Sedekah" style="height: 15rem" />
                            <div class="card-body">
