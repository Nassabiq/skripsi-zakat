...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <button class="btn btn-primary fs-6" type="button" id="search-button" data-bs-toggle="modal"
                    data-bs-target="#modalAddAgenda">
                    Tambah Agenda
                </button>
            </div>
        </div>
        ...
        {{-- Modal Add Agenda --}}
        <div class="modal fade" id="modalAddAgenda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row  p-2 rounded">
                                <input type="file" class="d-none" id="file" name="foto_agenda" accept="image/*" />
