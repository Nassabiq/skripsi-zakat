...
<div>
    ...
    <div id="content" style="transform: none" class="mt-4">
        {{ $count }}
        <button wire:click.prevent="counter">click</button>
                                ...
                                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="img/Kurban1.jpeg" class="d-block w-100 img-stretch"
                                                alt="Kurban1" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="img/Kurban2.jpeg" class="d-block w-100 img-stretch"
                                                alt="Kurban2" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="img/Kurban3.jpeg" class="d-block w-100 img-stretch"
                                                alt="Kurban3" />
                                        </div>
                                    </div>
